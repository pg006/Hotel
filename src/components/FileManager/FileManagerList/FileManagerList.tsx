    ...
    <Row className="row-sm">
      <Col lg={12} xl={12}>
        <Row className="row-sm">
          ...
          <Col xl={3} lg={3} md={4} sm={4} xxl={2}>
            <Card className="overflow-hidden">
              <a href={`${process.env.PUBLIC_URL}/filemanager/filedetails`} className="mx-auto my-3"><img src={require("../../../assets/images/media/files/pdf.png")} alt="img"/></a>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={3} lg={3} md={4} sm={4} xxl={2}>
            <Card className="overflow-hidden">
              <a href={`${process.env.PUBLIC_URL}/filemanager/filedetails`} className="mx-auto my-3"><img src={require("../../../assets/images/media/files/excel.png")} alt="img"/></a>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={3} lg={3} md={4} sm={4} xxl={2}>
            <Card className="overflow-hidden">
              <a href={`${process.env.PUBLIC_URL}/filemanager/filedetails`} className="mx-auto my-3"><img src={require("../../../assets/images/media/files/ppt1.png")} alt="img"/></a>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={3} lg={3} md={4} sm={4} xxl={2}>
            <Card className="overflow-hidden">
              <a href={`${process.env.PUBLIC_URL}/filemanager/filedetails`} className="mx-auto my-3"><img src={require("../../../assets/images/media/file-video.png")} alt="img"/></a>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={3} lg={3} md={4} sm={4} xxl={2}>
            <Card className="overflow-hidden">
              <a href={`${process.env.PUBLIC_URL}/filemanager/filedetails`} className="mx-auto my-3"><img src={require("../../../assets/images/media/files/word.png")} alt="img"/></a>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={3} lg={3} md={4} sm={4} xxl={2}>
            <Card className="overflow-hidden">
              <a href={`${process.env.PUBLIC_URL}/filemanager/filedetails`} className="mx-auto my-3"><img src={require("../../../assets/images/media/files/zip1.png")} alt="img"/></a>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
